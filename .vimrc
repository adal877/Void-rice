...
"================================================
map <C-h> <esc>:w <cr> :! clear && gcc % -o %run -lm && ./%run && x86_64-w64-mingw32-gcc %<cr>
" ===============================================
setlocal sm
set shiftwidth=4
set softtabstop=4
...
fu! Comm0n0ff()
	if !exists('g:hiddcomm')
		"ctermfg = 016 234
		let g:hiddcomm=1 | hi Comment ctermfg=53 guifg=#000000
	else
		"ctermfg = 046 201
...
map <leader>c <esc>:call Comment()<cr>
"==================================================
...
map <leader>cu <esc>:call Uncomment()<cr>
" =================================================
...
"cterm: 016 234
let s:medium_gray     = { "gui": "#000000", "cterm": "53", "cterm16" : "0" }
...
" void rice --- hi LineNr guibg=#C6C6C6 ctermbg=22
hi LineNr guibg=#C6C6C6 ctermbg=90
